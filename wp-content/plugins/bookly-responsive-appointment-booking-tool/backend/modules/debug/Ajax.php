...
class Ajax extends Lib\Base\Ajax
{
    ...
    public static function getFieldData()
    {
        ...
        $fields = array(
            ...
            'bookly_appointments.online_meeting_provider' => "enum('zoom','google_meet','jitsi') null default null",
            ...
            'bookly_mailing_campaigns.state' => "enum('pending','completed') not null default 'pending'",
            ...
            'bookly_services.online_meetings' => "enum('off','zoom','google_meet','jitsi') not null default 'off'",
